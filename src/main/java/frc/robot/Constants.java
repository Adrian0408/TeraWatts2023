...
public final class Constants {
    ...
    public static final int DRIVETRAIN_LEFT_FRONT_TALON = 20;
    public static final int DRIVETRAIN_RIGHT_FRONT_TALON = 21;
    public static final int DRIVETRAIN_LEFT_BACK_TALON = 22;
