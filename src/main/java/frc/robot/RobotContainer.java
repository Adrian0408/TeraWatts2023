...
// Joysticks
  ...
  public static XboxController armController_1 = new XboxController(Constants.ARM_CONTROLLER_1);
 ...
 m_ElbowSubsystem.setDefaultCommand(new RunArmJoystick(m_ElbowSubsystem, armController_1.getLeftY()));
  }
/*Should we rewrite RunArmJoystick to Xbox Controller? */
  /**
